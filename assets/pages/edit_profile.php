    ...
    <div class="col-12 bg-white border rounded p-4 mt-4 shadow-sm">
        <form method="post" action="assets/php/actions.php?updateprofile" enctype="multipart/form-data">
            ...
            <div class="form-floating mt-1">
                <input type="email" value="<?= $user['email'] ?>" name="email" class="form-control rounded-0" placeholder="email">
                <label for="floatingInput">Email</label>
            </div>
            <?= showError('email') ?>
            <div class="form-floating mt-1">
                <input type="tel" value="<?= $user['phone'] ?>" name="phone" class="form-control rounded-0" placeholder="Mobile Number">
            ...
            <?= showError('username') ?>
            <div class="form-floating mt-1">
                <input type="text" value="<?= $user['enrollment_number'] ?>" name="enrollment_number" class="form-control rounded-0" id="floatingPassword"
                    placeholder="Enrollment Number" disabled>
                <label for="floatingPassword">Enrollment Number</label>
            </div>
            <div class="form-floating mt-1">
                <input type="text" value="<?= $user['registration_number'] ?>" name="registration_number" class="form-control rounded-0" id="floatingPassword"
