...
<div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
    <div class="col-md-8 col-sm-12" style="max-width:72vw">
        ...
        showError('post_img');
        if (count($posts) < 1) {
            echo "<p style='width:72vw' class='p-1 bg-white border rounded text-center my-1 col-12'>Follow Someone or Add a new post</p>";
        }
        ...
        <div class="card mt-4">
            ...
            <div>
                ...
                <span style="font-size:small" class="text-muted">Posted</span>
